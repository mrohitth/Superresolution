...
# x1, y1, r1 = 0.02, 0.012, 0.005
# x2, y2, r2 = 0.12, 0.012, 0.005
...
poly = sg.Polygon([sg.Point(channel_length, 0.0, 0),
                sg.Point(channel_length, d3, 0),
                sg.Point(x_mid+0.03, d3, 0),
                sg.Point(x_mid, 0.025, 0),
                sg.Point(x_mid+0.03, channel_diameter-d2, 0),
                sg.Point(channel_length, channel_diameter-d2, 0),
                sg.Point(channel_length, channel_diameter, 0),
                sg.Point(x_mid+0.03, channel_diameter, 0),
                sg.Point(x_mid, (channel_diameter/2)+(d1/2), 0),
                sg.Point(0.0, (channel_diameter/2)+(d1/2), 0),
                sg.Point(0.0, (channel_diameter/2)-(d1/2), 0),
                sg.Point(x_mid, (channel_diameter/2)-(d1/2), 0),
...
# # domain = poly - cylinder - cylinder2

sg_geometry = poly.difference(cylinder1).difference(cylinder2)
...
poly = Polygon([Point(channel_length, 0.0, 0),
                Point(channel_length, d3, 0),
                Point(x_mid+0.03, d3, 0),
                Point(x_mid, 0.025, 0),
                Point(x_mid+0.03, channel_diameter-d2, 0),
                Point(channel_length, channel_diameter-d2, 0),
                Point(channel_length, channel_diameter, 0),
                Point(x_mid+0.03, channel_diameter, 0),
                Point(x_mid, (channel_diameter/2)+(d1/2), 0),
                Point(0.0, (channel_diameter/2)+(d1/2), 0),
                Point(0.0, (channel_diameter/2)-(d1/2), 0),
                Point(x_mid, (channel_diameter/2)-(d1/2), 0),
...
walls1 = 'on_boundary && x[1]>0 && x[0]>{0} && x[1]<={1} && x[0]<={2}'.format(x_mid, channel_diameter, x_mid+0.3)
