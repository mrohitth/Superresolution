...
# x, r = 1.04E-01, 3.50E-02
# x1, y1, r1 = 6.58E-02,	3.69E-02,	2.70E-03
# x2, y2, r2 = 1.71E-01,	1.97E-02,	6.03E-03
...
poly3 = sg.Polygon([sg.Point(0, 0), sg.Point(channel_length, 0), sg.Point(channel_length, channel_diameter), sg.Point(0.0, channel_diameter)])
curve1 = sg.Point(x, channel_diameter+0.03).buffer(r)
curve2 = sg.Point(x, -0.03).buffer(r)


sg_geometry = poly3.difference(curve1).difference(curve2).difference(cylinder1).difference(cylinder2)
...
box = Rectangle(Point(channel_diameter,0), Point(0.075, 0.0205))
...
curve1 = Circle(Point(x, channel_diameter+0.03), r, 16)
curve2 = Circle(Point(x, -0.03), r, 16)

domain = poly3 - curve1 - curve2 - cylinder - cylinder2 
...
c1 = 'on_boundary && x[0]>{0} && x[0]<{1} && x[1]>0 && x[1]<{2}'.format(x-r, x+r, channel_diameter)
...
# Assemble matrices
A1 = assemble(a1)
A2 = assemble(a2)# channel = Rectangle(Point(0, 0), Point(channel_length, 0.24))
A3 = assemble(a3)
